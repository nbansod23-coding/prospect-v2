...
//   contacts: Contact[];
//   onClose: () => void;
//   onComplete: (summary: CallOutcomeSummary) => void;
// }
...
//   /*
//    * Safety fallback:
//    * Every completed call must belong to one outcome.
//    * If the simulator returns an unexpected value,
//    * treat it as No Answer rather than losing the call.
//    */
//   return "noAnswer";
// }
...
//       const campaignOutcomes: CallOutcomeSummary = {
//         interested: 0,
//         notInterested: 0,
//         callBack: 0,
//         noAnswer: 0,
...
//          */
//         campaignOutcomes[outcome] += 1;

//         /*
//          * Total number of completed calls.
//          */
//         campaignOutcomes.called += 1;
...
export default function CallingCampaignModal({
  ...
  async function initializeAndCall() {
    ...
    try {
      ...
      /*
       * IMPORTANT:
       * Keep campaign results in a local variable.
       *
       * React setState is asynchronous, so using
       * `outcomes` directly inside this loop can
      ...
      for (
        ...
        const outcomeKey = getOutcomeKey(String(result));

        // setOutcomes((prev) => ({
        //   ...prev,
        //   [outcomeKey]: prev[outcomeKey] + 1,
        // }));
       ...
       *
       * ListsPage already uses this summary to update:
       *
       * Interested
       * Not Interested
       * Call Back
       ...
       */
      onComplete({
        interested: campaignOutcomes.interested,
        notInterested: campaignOutcomes.notInterested,
        callBack: campaignOutcomes.callBack,
        noAnswer: campaignOutcomes.noAnswer,
        called:
          campaignOutcomes.interested +
          campaignOutcomes.notInterested +
          campaignOutcomes.callBack +
